...
export class AuctionBuffersUpdated extends ethereum.Event {
  get params(): AuctionBuffersUpdated__Params {
    return new AuctionBuffersUpdated__Params(this);
  }
}

export class AuctionBuffersUpdated__Params {
  _event: AuctionBuffersUpdated;

  constructor(event: AuctionBuffersUpdated) {
    this._event = event;
  }
...
export class ListingAdded extends ethereum.Event {
  get params(): ListingAdded__Params {
    return new ListingAdded__Params(this);
  }
}

export class ListingAdded__Params {
  _event: ListingAdded;

  constructor(event: ListingAdded) {
    this._event = event;
  }
  ...
  get listing(): ListingAddedListingStruct {
    return changetype<ListingAddedListingStruct>(
      this._event.parameters[3].value.toTuple()
    );
  }
}

export class ListingAddedListingStruct extends ethereum.Tuple {
  get listingId(): BigInt {
...
export class ListingRemoved extends ethereum.Event {
  get params(): ListingRemoved__Params {
    return new ListingRemoved__Params(this);
  }
}

export class ListingRemoved__Params {
  _event: ListingRemoved;

  constructor(event: ListingRemoved) {
    this._event = event;
  }
...
export class tokeyMarketplaceV2Rinkeby__getPlatformFeeInfoResult {
  value0: Address;
  value1: i32;
...
export class tokeyMarketplaceV2Rinkeby__listingsResult {
  value0: BigInt;
  value1: Address;
  value2: Address;
  value3: BigInt;
...
export class tokeyMarketplaceV2Rinkeby__offersResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class tokeyMarketplaceV2Rinkeby__winningBidResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class tokeyMarketplaceV2Rinkeby extends ethereum.SmartContract {
  static bind(address: Address): tokeyMarketplaceV2Rinkeby {
    return new tokeyMarketplaceV2Rinkeby("tokeyMarketplaceV2Rinkeby", address);
  }
  ...
  getPlatformFeeInfo(): tokeyMarketplaceV2Rinkeby__getPlatformFeeInfoResult {
    let result = super.call(
      "getPlatformFeeInfo",
    ...
    return new tokeyMarketplaceV2Rinkeby__getPlatformFeeInfoResult(
      result[0].toAddress(),
      result[1].toI32()
    );
  }
  ...
  try_getPlatformFeeInfo(): ethereum.CallResult<
    tokeyMarketplaceV2Rinkeby__getPlatformFeeInfoResult
  > {
    let result = super.tryCall(
      "getPlatformFeeInfo",
      "getPlatformFeeInfo():(address,uint16)",
    ...
    return ethereum.CallResult.fromValue(
      new tokeyMarketplaceV2Rinkeby__getPlatformFeeInfoResult(
        value[0].toAddress(),
        value[1].toI32()
      )
    );
  ...
  listings(param0: BigInt): tokeyMarketplaceV2Rinkeby__listingsResult {
    let result = super.call(
      "listings",
      "listings(uint256):(uint256,address,address,uint256,uint256,uint256,uint256,address,uint256,uint256,uint8,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new tokeyMarketplaceV2Rinkeby__listingsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_listings(
    param0: BigInt
  ): ethereum.CallResult<tokeyMarketplaceV2Rinkeby__listingsResult> {
    let result = super.tryCall(
      "listings",
      "listings(uint256):(uint256,address,address,uint256,uint256,uint256,uint256,address,uint256,uint256,uint8,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new tokeyMarketplaceV2Rinkeby__listingsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toBigInt(),
  ...
  offers(
    param0: BigInt,
    param1: Address
  ): tokeyMarketplaceV2Rinkeby__offersResult {
    let result = super.call(
      "offers",
      "offers(uint256,address):(uint256,address,uint256,address,uint256,uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
    ...
    return new tokeyMarketplaceV2Rinkeby__offersResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_offers(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<tokeyMarketplaceV2Rinkeby__offersResult> {
    let result = super.tryCall(
      "offers",
      "offers(uint256,address):(uint256,address,uint256,address,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new tokeyMarketplaceV2Rinkeby__offersResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toAddress(),
  ...
  winningBid(param0: BigInt): tokeyMarketplaceV2Rinkeby__winningBidResult {
    let result = super.call(
      "winningBid",
    ...
    return new tokeyMarketplaceV2Rinkeby__winningBidResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_winningBid(
    param0: BigInt
  ): ethereum.CallResult<tokeyMarketplaceV2Rinkeby__winningBidResult> {
    let result = super.tryCall(
      "winningBid",
      "winningBid(uint256):(uint256,address,uint256,address,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new tokeyMarketplaceV2Rinkeby__winningBidResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toAddress(),
...
export class CancelDirectListingCall extends ethereum.Call {
  get inputs(): CancelDirectListingCall__Inputs {
    return new CancelDirectListingCall__Inputs(this);
  }

  get outputs(): CancelDirectListingCall__Outputs {
    return new CancelDirectListingCall__Outputs(this);
  }
}

export class CancelDirectListingCall__Inputs {
  _call: CancelDirectListingCall;

  constructor(call: CancelDirectListingCall) {
    this._call = call;
  }
...
export class CancelDirectListingCall__Outputs {
  _call: CancelDirectListingCall;
